...
const SECTIONS = [
  { icon: "checkmark-circle-outline", titleKey: "termsSection1Title", bodyKey: "termsSection1Body" },
  { icon: "person-outline", titleKey: "termsSection2Title", bodyKey: "termsSection2Body" },
  { icon: "card-outline", titleKey: "termsSection3Title", bodyKey: "termsSection3Body" },
  { icon: "ban-outline", titleKey: "termsSection4Title", bodyKey: "termsSection4Body" },
  { icon: "refresh-outline", titleKey: "termsSection5Title", bodyKey: "termsSection5Body" },
] as const;
...
export default function TermsOfService() {
  ...
  return (
    <SafeAreaView className="flex-1 bg-surface" edges={["top"]}>
      <Header title={t("termsOfService")} showBack />
      <ScrollView className="flex-1 px-4 pt-4" showsVerticalScrollIndicator={false}>
        ...
        <View className="bg-primary/5 border border-primary/10 rounded-2xl p-5 mb-5 items-center">
          <View className="w-14 h-14 rounded-full bg-primary/10 items-center justify-center mb-3">
            <Ionicons name="reader-outline" size={26} color={COLORS.primary} />
          </View>
